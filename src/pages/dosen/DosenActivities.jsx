...
const DosenActivities = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fadeIn">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 mb-16">
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
              Daftar kegiatan dan acara yang dilaksanakan oleh organisasi kemahasiswaan yang Anda bina
            </p>
          </div>
        </div>
      ...
      {loading ? (
        <Card>
          <Card.Body className="text-center py-20 text-gray-500">Memuat kegiatan...</Card.Body>
        </Card>
      ) : error ? (
        <Card>
...
export default DosenActivities;
